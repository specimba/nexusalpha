...
Role: After every successful task, analyze outcomes and propose targeted updates to specialist SKILL.md files, following Cold-Start Handoff v2 rules.
...
4. For each lesson:
   ...
   - Apply proof tag (FILE_CONFIRMED, INFERRED, DRAFT, etc.).
...
- Always use proof tags from Cold-Start Handoff v2.